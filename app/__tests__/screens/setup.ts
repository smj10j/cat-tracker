...
// ---------------------------------------------------------------------------
vi.mock('expo-print', () => ({
  printToFileAsync: vi.fn().mockResolvedValue({ uri: 'file:///tmp/sitter.pdf' }),
...
vi.mock('../../lib/api', () => ({
  api: {
    ...
    createJournalEntry: vi.fn().mockResolvedValue({ id: 'new-journal', cat_id: 'test-cat-123', user_id: 'user-1', author_name: null, occurred_at: '2026-07-02T12:00:00Z', text: '', tags: null, photo_url: null, created_at: '2026-07-02T12:00:00Z', updated_at: '2026-07-02T12:00:00Z' }),
    updateJournalEntry: vi.fn().mockResolvedValue({ id: 'j1', cat_id: 'test-cat-123', user_id: 'user-1', author_name: null, occurred_at: '2026-07-02T12:00:00Z', text: '', tags: null, photo_url: null, created_at: '2026-07-02T12:00:00Z', updated_at: '2026-07-02T12:00:00Z' }),
    ...
    getNotificationPrefs: vi.fn().mockResolvedValue({ digest_enabled: 0, digest_time: '08:00', digest_last_sent_date: null, quiet_hours_start: null, quiet_hours_end: null }),
    updateNotificationPrefs: vi.fn().mockImplementation((patch: any) => Promise.resolve({ digest_enabled: 0, digest_time: '08:00', digest_last_sent_date: null, quiet_hours_start: null, quiet_hours_end: null, ...patch })),
    setMedicationMute: vi.fn().mockResolvedValue({ muted: false }),
